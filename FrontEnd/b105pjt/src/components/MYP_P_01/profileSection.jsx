...
import { Paper, IconButton, Avatar, Modal, Box, Typography, Button, TextField, Divider } from '@mui/material';
    ...
    return (
        ...
        >
            ...
            <Box sx={{ position: 'relative', mb: 2 }}>
                <Avatar src={profile} alt="Profile" sx={{ width: 150, height: 150, borderRadius: '50%' }} />
                <IconButton
                    color="primary"
        ...
        <Modal open={open} onClose={handleCancle}>
            ...
            >
                ...
                <TextField
                    ...
                    sx={{ mt: 2, mb: 2 }}
                />
                <Button variant="contained" color="primary" onClick={handleUpdateBtn} sx={{ mt: 2, ml: 'auto' }}>
                    업데이트
                </Button>
            </Box>
        </Modal>
