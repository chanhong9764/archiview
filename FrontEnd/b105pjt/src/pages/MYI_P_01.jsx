    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <Container>
                ...
                {profileData && (
                    <ProfileSection
                        imageUrl={'홈페이지 URL/api/files/profile/' + profileData.id || 'default-image-url.jpg'}
                    >
                ...
                <SearchTab setQuestions={setQuestions} userId={userId} questions={questions} inView={inView} />
                <Grid container spacing={2}>
                    {questions.map((question) =>
                        question.replies.map((reply) => (
                            <Grid item xs={12} sm={6} md={4} key={reply.id}>
                                <Card onClick={() => handleViewDetails(question)} sx={cardStyles}>
                                    <CardMedia
                                        component="img"
                                        sx={mediaStyles}
                                        image={'홈페이지 URL/api/files/thumbnail/' + reply.thumbnailUrl}
                                        alt="Thumbnail Image"
                                    />
                                    <CardContent>
                                        <Typography
                                        ...
                                        <Typography variant="caption" sx={{ ...textOverflowStyles }} color="primary">
