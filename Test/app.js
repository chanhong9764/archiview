...
let APPLICATION_SERVER_URL = "https://i10b105.p.ssafy.io:8443/";
...
function getToken(callback) {
  ...
  httpRequest(
    "POST",
    APPLICATION_SERVER_URL + "api/recording/get-token",
    {
...
function removeUser() {
  httpRequest(
    "POST",
    APPLICATION_SERVER_URL + "api/recording/remove-user",
    {
      sessionName: sessionName,
      token: token,
    },
...
function closeSession() {
  httpRequest(
    "DELETE",
    APPLICATION_SERVER_URL + "api/recording/close-session",
    {
      sessionName: sessionName,
    },
...
function fetchInfo() {
  httpRequest(
    "POST",
    APPLICATION_SERVER_URL + "api/recording/fetch-info",
    {
      sessionName: sessionName,
    },
...
function fetchAll() {
  httpRequest(
    "GET",
    APPLICATION_SERVER_URL + "api/recording/fetch-all",
    {},
...
function forceDisconnect() {
  httpRequest(
    "DELETE",
    APPLICATION_SERVER_URL + "api/recording/force-disconnect",
    {
      sessionName: sessionName,
...
function forceUnpublish() {
  httpRequest(
    "DELETE",
    APPLICATION_SERVER_URL + "api/recording/force-unpublish",
    {
      sessionName: sessionName,
  ...
  function processRequest() {
    if (http.readyState == 4) {
      if (http.status == 200) {
        ...
        $("#textarea-http").text(
          errorMsg + ": HTTP " + http.status + " (" + http.responseText + ")"
        );
      }
    }
  }
...
function startRecording() {
  ...
  httpRequest(
    "POST",
    APPLICATION_SERVER_URL + "api/recording/recording/start",
    {
...
function stopRecording() {
  ...
  httpRequest(
    "POST",
    APPLICATION_SERVER_URL + "api/recording/recording/stop",
    {
...
function deleteRecording() {
  ...
  httpRequest(
    "DELETE",
    APPLICATION_SERVER_URL + "api/recording/recording/delete",
    {
      recording: forceRecordingId,
    },
...
function getRecording() {
  ...
  httpRequest(
    "GET",
    APPLICATION_SERVER_URL + "api/recording/recording/get/" + forceRecordingId,
    {},
    "Get recording WRONG",
    (res) => {
      console.log(res);
...
function listRecordings() {
  httpRequest(
    "GET",
    APPLICATION_SERVER_URL + "api/recording/recording/list",
    {},
